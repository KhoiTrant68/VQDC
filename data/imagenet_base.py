...
class BaseDataset(Dataset):
    def __init__(self, split, paths, size=None, random_crop=False, labels=None):
        ...
        # Combine transforms based on conditions, avoiding code duplication
        if split == "train":
    ...
    def preprocess_image(self, image_path):
        image = Image.open(image_path).convert("RGB")  # Convert mode while opening
